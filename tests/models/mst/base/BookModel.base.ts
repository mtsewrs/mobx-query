...
export const BookModelBase = ModelBase
  ...
  .props({
    typename: types.union(types.undefined, types.null, types.string),
        ...
        author: types.union(types.undefined, types.null, MSTGQLRef(types.late((): any => UserModel))),
        publisher: types.union(types.undefined, types.null, MSTGQLRef(types.late((): any => PublisherModel))),
        tags: types.union(types.undefined, types.null, types.array(types.union(types.null, MSTGQLRef(types.late((): any => BookTagModel))))),
      })
  .views(self => ({
    get store() {
