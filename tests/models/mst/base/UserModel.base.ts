...
export const UserModelBase = ModelBase
  ...
  .props({
    typename: types.union(types.undefined, types.null, types.string),
        ...
        friend: types.union(types.undefined, types.null, MSTGQLRef(types.late((): any => UserModel))),
        favouriteBook: types.union(types.undefined, types.null, MSTGQLRef(types.late((): any => BookModel))),
      })
  .views(self => ({
    get store() {
